    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad4()
        {
            ...
            var res2 = Emps.Where(x => x.Salary == ((from x2 in Emps select x2.Salary).Max()));
        ...
        {
            var res = from emp in Emps
                      group emp by emp.Job into prace
                      select new
                      {
                          Praca = prace.Key,
                          ilosc = Emps.Where(x => x.Job == prace.Key).Count()
                      };
        ...
        {
            var res = Emps.OrderByDescending(x => x.HireDate)
                            .First();
